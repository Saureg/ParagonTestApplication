...
namespace ParagonTestApplication.ApiTests.Tests.Webinars
{
    public class GetWebinarListTests : BaseWebinarsTests
    {
        ...
        public async Task GetWebinarFromListTest()
        {
            ...
            var response = await WebinarApiHelper.GetWebinarList(paginationFilter: new PaginationFilter
            {
                PageSize = 100500
            });
        ...
        {
            var response = await WebinarApiHelper.GetWebinarList();
        ...
        public async Task GetWebinarListWithPaginationFilterTest()
        {
            ...
            var response =
                await WebinarApiHelper.GetWebinarList(paginationFilter: new PaginationFilter(pageNumber, pageSize));
        ...
        {
            var webinarResponse1 = await WebinarApiHelper
                .CreateWebinar(CreateOrUpdateWebinarTestData.GenerateRequest(
                    startDateTime: "2020-12-12T12:00",
                    duration: 60
                ));
            var webinarResponse2 = await WebinarApiHelper
                .CreateWebinar(CreateOrUpdateWebinarTestData.GenerateRequest(
                    startDateTime: "2020-12-12T11:00",
                    duration: 61
                ));
            var webinarResponse3 = await WebinarApiHelper
                .CreateWebinar(CreateOrUpdateWebinarTestData.GenerateRequest(
            ...
            var response =
                await WebinarApiHelper.GetWebinarList(new WebinarFilter
                    {
        ...
        {
            var response = await WebinarApiHelper
