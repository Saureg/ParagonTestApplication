...
namespace ParagonTestApplication.Controllers
{
    ...
    public class WebinarController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedResponse<WebinarDto>>> Get([FromQuery] WebinarFilter webinarFilter,[FromQuery] PaginationFilter paginationFilter)
        {
            try
            {
                ...
                if (!results.IsValid)
                {
                    return BadRequest(new Response<WebinarDto>(null, HttpStatusCode.BadRequest, results.ToString()));
                }
                ...
                return Ok(new Response<PagedList<WebinarDto>>(webinarResult, HttpStatusCode.OK, null));
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult<WebinarDto>> Get(int id)
        {
            ...
            if (webinar == null)
            {
                return NotFound(new Response<WebinarDto>(null, HttpStatusCode.NotFound, $"Webinar with id={id} not found"));
            }
    
            var webinarDto = _mapper.Map<WebinarDto>(webinar);
            return Ok(new Response<WebinarDto>(webinarDto, HttpStatusCode.OK, null));
        }
        ...
        public async Task<ActionResult<WebinarDto>> Create(CreateOrUpdateWebinarRequest createOrUpdateWebinarRequest)
        {
            ...
            return CreatedAtAction(
                ...
                new Response<WebinarDto>(createdWebinarDto, HttpStatusCode.Created, null)
            );
        }
        
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] CreateOrUpdateWebinarRequest createOrUpdateWebinarRequest)
        {
            ...
            if (webinar == null)
            {
                return NotFound(new Response<WebinarDto>(null, HttpStatusCode.NotFound,
            ...
            return CreatedAtAction(
                ...
                new Response<Webinar>(updateWebinar, HttpStatusCode.Created, null)
                );
        }
